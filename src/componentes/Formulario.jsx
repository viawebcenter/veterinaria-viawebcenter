...
export default function Formulario({ pacientes, setPacientes, paciente, setPaciente }) {
  ...
  const Enviar = (e) => {
    ...
    // Determinar si se está creando o editando un registro
    if (paciente.id) {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <p className="text-lg mt-5 text-center mb-10">
        Añadir Paciente y {""} <span className="text-indigo-600 font-bold">Administrarlos</span>
      </p>
      <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5" onSubmit={Enviar}>
        {error && (
          <Error>
